...
1. Connect Arduino **Pin 9** to relay module **IN** pin
2. Connect Arduino **GND** to relay module **GND**
3. Connect Arduino **5V** to relay module **VCC**
...
1. Connect Arduino **Pin 9** to motor driver **IN1**
...
```
Pin 9:  Motor Control Output (Digital HIGH/LOW)
